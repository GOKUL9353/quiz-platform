...
urlpatterns = [
    ...
    path('admin/add-coding-question/<int:event_id>/<int:round_number>/', views.add_coding_question, name='add_coding_question'),
    path('admin/add-dubbing-question/<int:event_id>/<int:round_number>/', views.add_dubbing_question, name='add_dubbing_question'),
    path('api/delete-question/<int:event_id>/<int:round_number>/<int:question_id>/', views.delete_question, name='delete_question'),
    path('api/delete-coding-question/<int:event_id>/<int:round_number>/<int:question_id>/', views.delete_coding_question, name='delete_coding_question'),
    path('api/delete-dubbing-question/<int:event_id>/<int:round_number>/<int:question_id>/', views.delete_dubbing_question, name='delete_dubbing_question'),
